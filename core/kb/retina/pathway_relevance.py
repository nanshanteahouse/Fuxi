...
RETINA_KB_PATHWAY_MARKERS: dict[str, list[str]] = {
    "phototransduction": [
        "RHO", "OPN1SW", "OPN1MW", "OPN1LW", "GNAT1", "GNAT2",
        "PDE6A", "PDE6B", "PDE6G", "ARR3", "SAG", "RCVRN",
        "GRK1", "GUCY2D", "GUCA1A",
    ],
    "visual_perception": [
        "RHO", "OPN1SW", "OPN1MW", "OPN1LW", "CRX", "OTX2",
        "NRL", "NR2E3",
    ],
    "synapse": [
        "SLC17A6", "SLC17A7", "GAD1", "GAD2", "SLC32A1",
        "SYT1", "SYT2", "DLG4", "HOMER1",
    ],
    "retina_development": [
        "VSX2", "OTX2", "PAX6", "RAX", "SIX3", "SIX6",
        "LHX2", "SOX2", "VSX1", "PRDM1",
    ],
    "axon_guidance": [
        "NETO1", "NTN1", "DCC", "ROBO1", "ROBO2", "SLIT1",
        "EPHA5", "EPHB2", "SEMA3A",
    ],
    "photoreceptor_maintenance": [
        "PRPH2", "ROM1", "ABCA4", "CRB1", "RP1", "RP2",
        "RPGR", "USH2A",
    ],
    "cell_cycle": [
        "MKI67", "PCNA", "TOP2A", "CCND1", "CDK1", "CDK4",
    ],
}
