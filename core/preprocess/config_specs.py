...
_FRAGMENTS = FormatSpec(
    ...
    items=(
        ...
        SpecComment(("max_blacklist_ratio: 0.05",), indent=1),
        SpecComment(("min_peak_region_fragments: 300",), indent=1),
        SpecComment(("",)),
        SpecComment(("Peak calling",), indent=1),
        SpecField("atac.peak_qval", value=0.05),
        SpecField("atac.peak_width", value=500),
        SpecComment(("use_macs3: true",), indent=1),
        SpecComment(("",)),
        ...
        SpecComment(("",)),
        SpecComment(("Motif analysis",), indent=1),
        SpecField("atac.motif_db", value="JASPAR2024"),
        SpecComment(("",)),
        SpecComment(("── Dataset metadata ──",)),
        SpecField("tissue", placeholder="TISSUE"),
        SpecComment(
