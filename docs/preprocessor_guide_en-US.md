...
1. Use the templates in `templates/config_templates/` as a starting point for manual config (generated by `python -m core.config scaffold`; edit `core/preprocess/config_specs.py` and regenerate instead of editing templates by hand)
